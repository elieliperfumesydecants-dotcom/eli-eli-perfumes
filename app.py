...
# Inicialización segura: Funciona tanto en tu PC como en la Nube
if not firebase_admin._apps:
    try:
        ...
        if "firebase" in st.secrets:
            ...
            # CORRECCIÓN PARA EL ERROR DE FORMATO EN LA NUBE:
            # Asegura que los saltos de línea en la private_key sean procesados correctamente
